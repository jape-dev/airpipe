...
export class DefaultService {
   ...
   * @throws ApiError
   */
  public static adAccountsConnectorGoogleAnalyticsAdAccountGet(
    token: string
  ): CancelablePromise<Array<AdAccount>> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static runQueryConnectorGoogleAnalyticsRunQueryPost(
    token: string,
    requestBody: GoogleQuery
  ): CancelablePromise<GoogleQueryResults> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/connector/google-analytics/run_query",
      query: {
        token: token,
      },
      body: requestBody,
